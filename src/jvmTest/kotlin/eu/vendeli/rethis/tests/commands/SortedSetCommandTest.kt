...
class SortedSetCommandTest : ReThisTestCtx() {
    @Test
    fun `test BZMPOP command`(): Unit = runBlocking {
    ...
    @Test
    fun `test BZPOPMAX command`(): Unit = runBlocking {
    ...
    @Test
    fun `test ZUNIONSTORE command`(): Unit = runBlocking {
