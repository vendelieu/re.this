...
class ListCommandTest : ReThisTestCtx() {
    @Test
    fun `test BLMOVE command`(): Unit = runTest {
    ...
    @Test
    fun `test BLMPOP command`(): Unit = runTest {
    ...
    @Test
    fun `test LMPop command`(): Unit = runTest {
    ...
    @Test
    fun `test LPOP command`(): Unit = runTest {
        client.lPush("testKey12", "testValue12")
        client.lPop("testKey12") shouldBe "testValue12"
    }

    @Test
    fun `test LPOP command with count`(): Unit = runTest {
