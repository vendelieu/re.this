...
class ScriptCommandTest : ReThisTestCtx() {
    @Test
    fun `test EVAL command`(): Unit = runBlocking {
    ...
    @Test
    fun `test EVAL_RO command`(): Unit = runBlocking {
        val script = "return {KEYS[1],ARGV[1]}"
    ...
    @Test
    fun `test EVALSHA command`(): Unit = runBlocking {
        val script = "return {KEYS[1],ARGV[1]}"
    ...
    @Test
    fun `test EVALSHA_RO command`(): Unit = runBlocking {
        val script = "return {KEYS[1],ARGV[1]}"
        val sha1 = client.scriptLoad(script).shouldNotBeNull()
    ...
    @Test
    fun `test FCALL command`(): Unit = runBlocking {
    ...
    @Test
    fun `test FCALL_RO command`(): Unit = runBlocking {
        val script =
    ...
    @Test
    fun `test FUNCTION DELETE command`(): Unit = runBlocking {
    ...
    @Test
    fun `test FUNCTION DUMP command`(): Unit = runBlocking {
    ...
    @Test
    fun `test FUNCTION FLUSH command`(): Unit = runBlocking {
        client.functionFlush() shouldBe "OK"
    }

    @Test
    fun `test FUNCTION KILL command`(): Unit = runBlocking {
        val script =
            "#!lua name=mylib10\n" +
    ...
    @Test
    fun `test FUNCTION LIST command`(): Unit = runBlocking {
        shouldNotThrowAny {
    ...
    @Test
    fun `test FUNCTION LOAD command`(): Unit = runBlocking {
    ...
    @Test
    fun `test FUNCTION RESTORE command`(): Unit = runBlocking {
    ...
    @Test
    fun `test FUNCTION STATS command`(): Unit = runBlocking {
    ...
    @Test
    fun `test SCRIPT DEBUG command`(): Unit = runBlocking {
        client.scriptDebug("SYNC") shouldBe "OK"
    }

    @Test
    fun `test SCRIPT EXISTS command`(): Unit = runBlocking {
        val script = "return {KEYS[1],ARGV[1]}"
        val sha1 = client.scriptLoad(script).shouldNotBeNull()
    ...
    @Test
    fun `test SCRIPT FLUSH command`(): Unit = runBlocking {
        client.scriptFlush() shouldBe "OK"
    }

    @Test
    fun `test SCRIPT KILL command`(): Unit = runBlocking {
        client.coLaunch {
            client
                .eval(
    ...
    @Test
    fun `test SCRIPT LOAD command`(): Unit = runBlocking {
        val script = "return {KEYS[1],ARGV[1]}"
