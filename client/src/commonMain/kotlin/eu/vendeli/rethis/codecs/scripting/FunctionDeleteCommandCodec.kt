...
public object FunctionDeleteCommandCodec {
    ...
    public suspend fun encode(charset: Charset, libraryName: String): CommandRequest {
        val buffer = Buffer()
    ...
    public suspend inline fun encodeWithSlot(charset: Charset, libraryName: String): CommandRequest = encode(charset, libraryName = libraryName)
