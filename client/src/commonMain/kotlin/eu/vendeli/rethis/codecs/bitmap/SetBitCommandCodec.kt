...
public object SetBitCommandCodec {
    ...
    public suspend fun encode(
        ...
        buffer.writeLongArg(offset, charset, )
        buffer.writeLongArg(value, charset, )
    ...
    public suspend inline fun encodeWithSlot(
        ...
        val request = encode(charset, key = key, offset = offset, value = value)
