...
public object ClusterFailoverCommandCodec {
    ...
    public suspend inline fun encodeWithSlot(charset: Charset, options: ClusterFailoverOption?): CommandRequest = encode(charset, options = options)
