...
public object FunctionFlushCommandCodec {
    ...
    public suspend fun encode(charset: Charset, flushType: FlushType): CommandRequest {
        ...
        buffer.writeStringArg(flushType.toString(), charset)

        return CommandRequest(buffer, RedisOperation.WRITE, BLOCKING_STATUS)
    }

    public suspend inline fun encodeWithSlot(charset: Charset, flushType: FlushType): CommandRequest = encode(
        charset,
        flushType = flushType,
    )
