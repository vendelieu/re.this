...
public object PExpireCommandCodec {
    ...
    public suspend fun encode(
        ...
        size += 1
        buffer.writeDurationArg(milliseconds, charset, TimeUnit.SECONDS)
        condition?.let { it0 ->
            when (it0) {
    ...
    public suspend inline fun encodeWithSlot(
        ...
        val request = encode(charset, key = key, milliseconds = milliseconds, condition = condition)
