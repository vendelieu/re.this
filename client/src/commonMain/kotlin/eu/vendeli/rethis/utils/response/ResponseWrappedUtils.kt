...
import eu.vendeli.rethis.api.spec.common.types.RType.Error
...
private fun ArrayDeque<ResponseToken>.readSimpleResponseWrapped(
    ...
    return when (typeToken.code) {
        ...
        else -> throw ResponseParsingException(message = "Invalid response type for simple response: ${typeToken.code}")
    }
}
