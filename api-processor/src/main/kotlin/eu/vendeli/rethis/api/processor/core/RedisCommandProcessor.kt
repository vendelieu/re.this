...
import eu.vendeli.rethis.api.processor.utils.currentCommand
...
import eu.vendeli.rethis.api.processor.validator.RedisProcessor.process
...
class RedisCommandProcessor(
    ...
    override fun process(resolver: Resolver): List<KSAnnotated> {
        ...
        context.resolvedSpecs.spec.forEach {
            ...
            runCatching { process(it.key) }.onFailure {
                println(context.currentCommand.command.name + "\n" + it.stackTraceToString())
            }
